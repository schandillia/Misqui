...
// Declare module augmentations for NextAuth
...
// Async factory function to configure NextAuth with initialized db
async function createAuthConfig(): Promise<NextAuthConfig> {
  const initializedDb = await initializeDb() // Ensure db is initialized
