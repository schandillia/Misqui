  ...
  return (
    <div className="hidden lg:block w-[368px] sticky self-end bottom-6">
      <div className="min-h-[calc(100vh-48px)] sticky top-6 flex flex-col justify-between">
        ...
        <div className="uppercase pt-6 text-xs font-bold text-muted-foreground flex flex-wrap justify-between gap-x-4 gap-y-2 border-t border-gray-200 mt-6 px-2">
