    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          translate-y-[-50%] gap-4 rounded-3xl border p-6 shadow-lg duration-200
          sm:max-w-lg dark:border-2 dark:border-neutral-500`,
          className
        )}
        {...props}
      >
        ...
        <DialogPrimitive.Close
          className="ring-offset-background focus:ring-ring data-[state=open]:bg-accent
            data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-lg
