  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          `placeholder:text-muted-foreground flex h-10 w-full rounded-3xl bg-transparent
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        ...
        items-center gap-2 rounded-3xl px-2 py-1.5 text-sm outline-hidden select-none
