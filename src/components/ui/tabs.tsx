  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        rounded-3xl p-[3px] border-1 border-muted`,
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        data-[state=inactive]:text-muted-foreground inline-flex h-[calc(100%-1px)]
        flex-1 items-center justify-center gap-1.5 rounded-3xl border border-transparent
